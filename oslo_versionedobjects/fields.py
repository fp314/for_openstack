...
#Field-->AutoTypedField-->StringField;IntegerField;FloatField;ObjectField等--------包装以下方法
#AbstractFieldType-->FieldType-->String;Integer;Float;Object等---coerce();from_primitive();to_primitive();stringify();get_schema()等重要方法
...
class Field(object):
    ...
    def _null(self, obj, attr): #设置为none或默认值
        if self.nullable:
            return None
