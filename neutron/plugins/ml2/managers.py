...
class TypeManager(stevedore.named.NamedExtensionManager):
    ...
    def __init__(self):
        ...
        super(TypeManager, self).__init__('neutron.ml2.type_drivers',
                                          cfg.CONF.ml2.type_drivers,    #default=['local', 'flat', 'vlan', 'gre', 'vxlan', 'geneve']
                                          invoke_on_load=True)
...
class ExtensionManager(stevedore.named.NamedExtensionManager):
    ...
    def __init__(self):
        ...
        super(ExtensionManager, self).__init__('neutron.ml2.extension_drivers', #port_security = neutron.plugins.ml2.extensions.port_security:PortSecurityExtensionDriver
                                               cfg.CONF.ml2.extension_drivers,
                                               invoke_on_load=True,
                                               name_order=True)
