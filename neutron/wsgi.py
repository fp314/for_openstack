...
class Server(object):
    ...
    def __init__(self, name, num_threads=None, disable_ssl=False):
        ...
        self.num_threads = num_threads or CONF.wsgi_default_pool_size   #wsgi_default_pool_size = 100
        self.disable_ssl = disable_ssl  #安全相关
        # Pool for a greenthread in which wsgi server will be running
        self.pool = eventlet.GreenPool(1)
        self.name = name    #"Neutron"
        self._server = None
        # A value of 0 is converted to None because None is what causes the
        # wsgi server to wait forever.
        self.client_socket_timeout = CONF.client_socket_timeout or None #client_socket_timeout = 900
    ...
    def start(self, application, port, host='0.0.0.0', workers=0):
        ...
        self._host = host
        self._port = port
        backlog = CONF.backlog  #default=4096,
