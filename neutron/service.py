...
def _run_wsgi(app_name):
    app = config.load_paste_app(app_name)  #app =  deploy.loadapp("api-paste.ini",app_name---"neutron")
    if not app:
...
def run_wsgi_app(app):
    ...
    server.start(app, cfg.CONF.bind_port, cfg.CONF.bind_host,   #default=9696
