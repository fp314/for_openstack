...
class ExtensionManager(object):
    ...
    def __init__(self):
        ...
        self.cls_list = CONF.osapi_volume_extension     #default=['cinder.api.contrib.standard_extensions']
        self.extensions = {}    #保存获取cinder.api.contrib目录下的controller
    ...
    def _load_extensions(self):
        ...
        for ext_factory in extensions:
            try:
                self.load_extension(ext_factory) #执行下面的load_standard_extensions(self)方法。
...
#在cinder.api.contrib目录目录下调用：获取cinder.api.contrib目录下的py文件，对其中文件名首字母大写的class,ext_mgr.load_extension(clss)
